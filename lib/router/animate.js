...
module.exports = function animate(next_page, animation, callback) {
  ...
  if (animation === "update") {
    ...
    this.pageCache[next_page]._render(false, App.DOM[this.inactivePageElement], function() {
      ...
      self._doFirst("beforeAnimate", function(err) {
        ...
        self.doAnimation(animation_data, function () {
          ...
          var focusElement = App.DOM[self.inactivePageElement].querySelector(".samson_focus");
          if (focusElement) {
