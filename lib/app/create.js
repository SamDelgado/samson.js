...
module.exports = function createApp(options, callback) {
    ...
    if (Samson.App._isConfigured === true) {
      ...
      Samson.App.Router = Samson.createRouter(options.Router || options.router || {});
      ...
      Samson.App.delegate = Gator(Samson.App.DOM.samson_app);

      // Load any other components
      var keys = Object.keys(Samson.App._components);
      Async.each(keys, function(key, cb) {

        Samson.App.Components[key] = Samson.createComponent(Samson.App._components[key], false);
        Samson.App.Components[key].parent = {element: Samson.App.DOM.samson_app, delegate: Samson.App.delegate};
