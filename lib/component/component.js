...
var reserved_props = ["path", "el", "element", "tag", "template", "subPageOf", "previousPage", "backAnimation", "style", "Components", "events", "DOMEvents", "AppEvents", "state", "setState", "resetState", "setInitialState", "beforeRender", "afterRender", "onLoad", "onVisible", "beforeRemove", "render", "parent", "on", "emit", "off"];
var on_capture_events = ['blur', 'error', 'focus', 'load', 'resize', 'scroll'];

// cache these functions for better performance
