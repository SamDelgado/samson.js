    ...
    Async.each(old_components, function(old_component, cb) {
      ...
      if (should_be_loaded) {
        ...
        if (!self.Components[old_component]) {
          self.Components[old_component] = createComponent(self._components[old_component], false);
      ...
      for (component in self._components) {
        if (!self.Components[component]) {
          self.Components[component] = createComponent(self._components[component], false);
